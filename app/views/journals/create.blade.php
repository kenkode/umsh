...
.ui-dialog-titlebar-close:hover {
  ...
  $(function() {
    ...
    function addUser() {
      ...
      valid = valid && checkRegexp( name, /^[a-z]([0-9a-z_\s])+$/i, "Please insert a valid account code." );
    ...
    <fieldset>
        <div class="form-group">
            ...
            <div class="right-inner-addon ">
                        ...
                        <input class="form-control journaldate" readonly="readonly" placeholder="" type="text" name="date" id="date" value="{{{ Input::old('date') }}}">
                        </div>
        </div>
